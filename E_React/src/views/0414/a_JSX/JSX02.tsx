...
export default function JSX02() {
    ...
    const divStyle = {
        // 스타일 규칙이 객체로 인식되기 떄문에 속성값에 문자열이 존재하면 반드시 '' 따옴표로 묶어야 한다.
        // 숫자값은 그대로 사용 가능하다
    ...
    return (
        <>
            {/* 
                HTML 내에서 JS의 속성 지정 
                : JSX에서 문자열, 숫자, 기타 JS 표현식 뿐만 아니라 객체까지도 모두 중괄호 내에 작성
            */}
            ...
            {/* 속성에서 중괄호 사용 */}
            <div style={{backgroundColor: 'black', color: 'pink', marginTop: '10px'}}>{text}</div>
