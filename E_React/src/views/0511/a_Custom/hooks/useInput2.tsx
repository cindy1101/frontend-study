...
interface UseInputReturn {
  ...
  // 입력 필드의 값을 설정하는 함수, React.Dispatch 는 React에 명시된 타입
  // 상태의 대한 이전값, 현재값, 앞으로의 값이 string으로 지정이 된다
  setValue: React.Dispatch<React.SetStateAction<string>>; 
  reset: () => void; // 입력 필드의 값으로 초기값을 reset하는 함수
  bind: {
...
// & 초기값을 매개변수로 받고, 입력 상태를 관리하는 커스텀 훅
