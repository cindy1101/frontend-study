...
// 1. 콜백함수 (callback) -> 함수를 매개변수로?
// : 다른 함수의 인자로 전달되어, 그 함수의 내부에서 실행되는 함수
// : 비동기 작업, 이벤트 처리, 특정 조건에 따른 함수 실행 등에 사용됩니다.
...
// ! 콜백함수를 활용하는 자바스크립트 내장 함수

// 배열이 가지는 콜백 함수 활용 메서드의 형태
