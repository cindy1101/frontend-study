...
// ? 1. 배열의 모든 요소에 함수를 적용 map()
// numbers 라는 이름의 배열을 생성하고 1 ~ 10까지의 숫자를 요소로 채움
// double 이라는 이름의 함수를 작성합니다. 이 함수는 숫자를 매개 변수로 받아 그 숫자의 두 배를 반환
...
const scores = [55, 60, 60, 80, 90, 45, 75, 85, 95, 65];
