...
// ? DOM 사용
// : JS를 사용하여 DOM에 접근하는 경우 웹 페이지의 요소(HTML 요소?)를 선택, 추가, 수정, 삭제하는데 필요한 메서드와 속성에 접근이 가능
...
// ? document.body
// : 문서의 body 요소를 읽어오기 (head, title 등도 가능하다)
