...
let objectName = {
    ...
    // 키2 : 값2,
    // ... (원하는 데이터를 무한대로)
    // : 값의 데이터 형식에는 제한이 없다. (배열, 또 다른 객체, 함수 모두 사용 가능)
}
...
//     console.log(`hello, ${this.name.last}`);
//     ? this.name.last는
//     : this 는 해당 코드를 가지고 있는 dog 객체 그 자체 === dog.name.last 와 동일 (점 표기법을 사용한 속성에 접근)
// }
...
// human1과 human2는 서로 다른 객체이기 떄문에
// : 각각의 이름으로 생성됨
// : this 가 가리키는 객체가 다름 (실행중인 코드가 속한 객체)
