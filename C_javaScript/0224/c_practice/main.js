...
// newItem을 todoList(할일 목록)의 자식 요소로 추가
// 하위 요소를 추가하는 방법
// : 상위요소.appendChild(하위요소)

todoList.appendChild(newItem);

// 입력창의 내용은 사용 후 비우는 것이 원칙
todoInput.value = '';
...
// : todoList 내의 어떤 항목이든 클릭할 때마다 정의된 함수가 실행
todoList.addEventListener('click', function(e){
    // 클릭된 요소가 'li' 태그 (목록 항목)인지 확인
    // 전달 받은 이벤트에서 이벤트가 발생한 요소의 태그명을 전달 받아 LI와 일치하는지 확인
    // : tagName은 대문자로 작성되어 있음
