...
console.log(user1); //{ id: 0, username: '이승아', role: 'user' }
console.log(updateUserRole(user1, 'admin')); //{ id: 0, username: '이승아', role: 'admin' }
...
// ! 3. union, intersection, literal, function type을 활용한 고급 타입 만들기

// 요구 사항
// 1. 고객 정보를 나타내는 타입(CustomInfo) - 인터페이스
// : 고객의 name(string)과 email(string), status를 포함, status는 "active", "inactive", "prospective" 중 하나의 값을 가질 수 있는 리터럴 타입
