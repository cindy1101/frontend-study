{
    ...
    // ? 2. 인터섹션 타입
    // : 여러 타입을 하나로 결합하여, 모든 주어진 타입의 속성을 포함하는 새로운 타입을 생성
    // : 그리고 (and &)
    ...
    // : 객체 자체를 객체 변수에 새롭게 부여할 때는 오류가 나지 않는다.
    // : 객체가 생성된 후에 해당 속성값만을 변경하면 오류가 난다.
